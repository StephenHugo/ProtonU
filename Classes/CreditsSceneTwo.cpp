...
Scene* Credit2::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = Credit2::create();
...
bool Credit2::init()
{
    ...
    auto background = MenuItemImage::create(
                                           ABOUT2,
                                           ABOUT2,
                                           CC_CALLBACK_1(Credit2::gotomenuCallback, this));
    ...
    this->scheduleOnce(schedule_selector(Credit2::gotonextScene), LAUNCHTRANSITIONTIME);
...
void Credit2::gotonextScene(float dt)
{
    auto creditsScene = Credit3::createScene();
...
void Credit2::gotomenuCallback(Ref* pSender)
{
