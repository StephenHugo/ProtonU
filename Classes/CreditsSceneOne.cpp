...
Scene* Credit1::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();
    
    // 'layer' is an autorelease object
    auto layer = Credit1::create();
...
bool Credit1::init()
{
    ...
    auto background = MenuItemImage::create(
                                           ABOUT1,
                                           ABOUT1,
                                           CC_CALLBACK_1(Credit1::gotomenuCallback, this));
    ...
    this->scheduleOnce(schedule_selector(Credit1::gotonextScene), LAUNCHTRANSITIONTIME);
...
void Credit1::gotonextScene(float dt)
{
    auto creditsScene = Credit2::createScene();
...
void Credit1::gotomenuCallback(Ref* pSender)
{
